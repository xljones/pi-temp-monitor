...
class TemperatureController:
    ...
    def _get_temperature(self, faranheit):
    ...
    def monitor_temperature(self):
        while (True):
            print("     {0}: {1}".format(self._get_timestamp(), self._get_temperature(args.faranheit)), end="\r")
            time.sleep(1)
...
if (__name__ == "__main__"):
    ...
    p.add_argument('-f', '--faranheit', help='Show temperature in degress Faranheit, default is to use degrees Celsius', action='store_true')
    args = p.parse_args()
